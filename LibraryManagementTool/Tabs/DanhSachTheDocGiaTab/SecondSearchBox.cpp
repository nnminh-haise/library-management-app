...
READER_SECOND_SEARCH_BOX::SearchBox::SearchBox()
{
	this->Initialize();
}

READER_SECOND_SEARCH_BOX::SearchBox::SearchBox(const SearchBox& other)
{
	if (this != &other)
	{
		this->~SearchBox();
...
READER_SECOND_SEARCH_BOX::SearchBox& READER_SECOND_SEARCH_BOX::SearchBox::operator=(const READER_SECOND_SEARCH_BOX::SearchBox& other)
{
...
void READER_SECOND_SEARCH_BOX::SearchBox::SetPackage(Package* package)
{
	this->package_ = package;
}

void READER_SECOND_SEARCH_BOX::SearchBox::SetSearchData(LinearList<AVL_TREE::Pointer>* data) { this->searchData_ = data; }

void READER_SECOND_SEARCH_BOX::SearchBox::SetReaderDatasheetPackage(READER_TABLE_SORTED_BY_NAME::DatasheetProcessor* datasheetPackage)
{
...
*/
bool READER_SECOND_SEARCH_BOX::SearchBox::SearchOperation()
{
	...
	int dataSetSize = this->searchData_->Size();
	DataFilter*& dataFilter = this->readerTablePackage_->AccessDataFilter();
	std::string readerID{};
	...
	{
		auto currentNode = (*this->searchData_)[i];
		...
		if (res)
		{
			...
			if (dataFilter->filters_[i] == false)
			{
				// Update filter
...
void READER_SECOND_SEARCH_BOX::SearchBox::SearchBoxOnAction()
{
...
void READER_SECOND_SEARCH_BOX::SearchBox::Display()
{
...
int READER_SECOND_SEARCH_BOX::SearchBox::Run()
{
...
void READER_SECOND_SEARCH_BOX::SearchBox::Initialize()
{
...
void READER_SECOND_SEARCH_BOX::SearchBox::InitializeSearchFilters()
{
